                    ...
                    <div className="space-y-8 text-zinc-300">
                        <section>
                            <p className="mb-4">
                                ...
                                https://melodycollabcom (the "Site" or "we")
                                collects, uses, and discloses your Personal
                                Information when you visit or make a purchase
                                from the Site.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                ...
                                information about your device, your interaction
                                with the Site, and information necessary to
                                process your purchases. We may also collect
                                additional information if you contact us for
                                customer support. In this Privacy Policy, we
                                refer to any information that can uniquely
                                identify an individual (including the
                                information below) as "Personal Information".
                                See the list below for more information about
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc pl-6 space-y-2">
                                        <li>
                                            ...
                                            PayPal), email address, and phone
                                            number.
                                        </li>
                                        <li>
                                            <span className="font-medium">
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                The Site is not intended for individuals under
                                the age of 12. We do not intentionally collect
                                Personal Information from children. If you are
                                the parent or guardian and believe your child
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                ...
                                providers to help us provide our services and
                                fulfill our contracts with you, as described
                                above. For example:
                            </p>
                            <ul className="list-disc pl-6 space-y-2">
                                <li>
                                    We use Shopify to power our online store.
                                    You can read more about how Shopify uses
                                ...
                                <li>
                                    ...
                                    to respond to a subpoena, search warrant, or
                                    other lawful request for information we
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2 mb-4">
                                <li>
                                    ...
                                    You can read more about how Google uses your
                                ...
                                <li>
                                    We share information about your use of the
                                    Site, your purchases, and your interaction
                                    with our ads on other websites with our
                                    advertising partners. We collect and share
                                    some of this information directly with our
                                    advertising partners, and in some cases
                                    through the use of cookies or other similar
                                    technologies (which you may consent to,
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                We use your personal Information to provide our
                                services to you, which includes: offering
                                products for sale, processing payments, shipping
                                and fulfillment of your order, and keeping you
                                up to date on new products, services, and
                                offers.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                ...
                                Regulation ("GDPR"), if you are a resident of
                                the European Economic Area ("EEA"), we process
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                <li>Your consent;</li>
                                <li>
                                    The performance of the contract between you
                                    and the Site;
                                </li>
                                ...
                                <li>
                                    For our legitimate interests, which do not
                                    override your fundamental rights and
                                    freedoms.
                                </li>
                            </ul>
                        </section>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="mb-4">
                                        ...
                                        Information we hold about you, to port
                                    ...
                                    <p className="mb-4">
                                        ...
                                        initially processed in Ireland and then
                                        will be transferred outside of Europe
                                        for storage and further processing,
                                        including to Canada and the United
                                        States.
                                    </p>
                                </div>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                ...
                                downloaded to your computer or device when you
                                visit our Site. We use a number of different
                                cookies, including functional, performance,
                                advertising, and social media or content
                                cookies. Cookies make your browsing experience
                                better by allowing the website to remember your
                                actions and preferences (such as login and
                                region selection). This means you don't have to
                                re-enter this information each time you return
                                to the site or browse from one page to another.
                                Cookies also provide information on how people
                                use the website, for instance whether it's their
                                first time visiting or if they are a frequent
                                visitor.
                            </p>
                            <p className="mb-4">
                                Most browsers automatically accept cookies, but
                                you can choose whether or not to accept cookies
                                through your browser controls, often found in
                                your browser's "Tools" or "Preferences" menu.
                                For more information on how to modify your
                                browser settings or how to block, manage or
                                filter cookies can be found in your browser's
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                Please note that because there is no consistent
                                industry understanding of how to respond to "Do
                                Not Track" signals, we do not alter our data
                                collection and usage practices when we detect
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                ...
                                to our practices or for other operational,
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                ...
                                us by e-mail at info@melodycollab.com or by mail
                                using the details provided below:
                            </p>
                            <p className="mb-4">
                                61 Reynolds Street, Parrish AL 35580, United
                                States
                            </p>
                            <p className="mb-4">
                                If you are not satisfied with our response to
                                your complaint, you have the right to lodge your
                                complaint with the relevant data protection
                                authority. You can contact your local data
                                protection authority, or our supervisory
                                authority here:
