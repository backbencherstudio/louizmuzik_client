    ...
    <div className="flex h-screen bg-zinc-950">
      ...
      <aside className="w-64 bg-zinc-900/50 border-r border-zinc-800 p-4">
        ...
        <nav className="">
          ...
          <button onClick={() => router.push("/dashboard")} className="w-full flex items-center justify-center gap-2 border border-emerald-500 text-emerald-500 rounded-lg px-3 py-2 hover:bg-emerald-500 hover:text-black transition-all">
