...
export default function AccountPage() {
  ...
  // https://www.paypal.com/connect?client_id=AeMnBMlrboT2yZ77Ny1Zuwm-UnhJeeMzvE1D1ana1ZetUAzPfo7C-Px41iR4FijH5SN1FHEYrGokg3G2&response_type=code&scope=openid&redirect_uri=${process.env.NEXT_PUBLIC_API_URL}/api/v1/payment/paypal-callback
  return (
    <Layout>
