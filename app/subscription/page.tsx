                ...
                <div className="max-w-[1000px] mx-auto px-4">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-zinc-400">
                            View your current plan, update your payment details,
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                <p className="text-white">
                                    Visa ending in{' '}
                                    {subscriptionData.paymentMethod.lastFour}
                                </p>
                                <p className="text-sm text-zinc-400">
                                    Expires{' '}
                                    {subscriptionData.paymentMethod.expiryDate}
                                </p>
                            </div>
                        </div>
                ...
                <DialogContent className="bg-[#0F0F0F] border-zinc-800 p-0">
                    <div className="relative p-6">
                        ...
                        <p className="text-zinc-400 mb-8">
                            Your subscription will remain active until April 15,
                            2025. After that, your account will be downgraded to
                            the Free plan.
                        </p>
